...
import probabilidades from "../../images/probabilidad.png";
...
import EnsayoPersonalizado from "../pruebas/EnsayoPersonalizado";
import MetodoPrePAES from "../metodoPrePAES/MetodoPrePAES";
...
function Menu() {
  ...
  const [showMetodoPrePAES, setShowMetodoPrePAES] = useState(false);
  ...
  const handleSidebar = (option) => {
    ...
    else if (option === "metodoPrePAES") {
      setShowHistorial(false);
      setShowCrearEnsayo(false);
      setShowEnsayos(false);
      setShowMetodoPrePAES(true);
    }
          ...
          <section className="section-menu">
            ...
            <div className="sidebar " >
              ...
              <ul>
                ...
                <motion.li whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  transition={{ duration: 0.15 }}><a className={showMetodoPrePAES ? "active" : ""} href="#" onClick={() => handleSidebar("metodoPrePAES")} >Método PrePAES</a></motion.li>
                <motion.li whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
            ...
            {!showCrearEnsayo && !showhistorial && !showMetodoPrePAES && (
              ...
              <div className="content">
                ...
                /> */}
                    ...
                    {essays.map((essay) => (
                      <NombreEnsayo
                        temario={essay.type === "numeros" ? "Números" : essay.type === "algebra" ? "Álgebra y Funciones" : essay.type === "geometria" ? "Geometría" : essay.type === "probabilidades" ? "Probabilidad y Estadísticas" : "Ensayo General"}
                        imagen={essay.type === "numeros" ? numeros : essay.type === "algebra" ? algebra : essay.type === "geometria" ? geometria : essay.type === "probabilidades" ? probabilidades : crearEnsayo}
                        urlEnsayo={essay.type}
                        idEnsayo={essay.id}
